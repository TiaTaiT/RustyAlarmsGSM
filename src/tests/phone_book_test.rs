...
#[test]
fn test_phone_book_adds_and_retrieves_numbers() {
...
#[test]
fn test_phone_book_rejects_duplicates_and_too_long_numbers() {
    let mut book = PhoneBook::new();
...
#[test]
fn test_phone_book_stops_accepting_numbers_when_full() {
    let mut book = PhoneBook::new();
